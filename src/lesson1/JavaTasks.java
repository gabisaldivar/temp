...
public class JavaTasks {
    ...
    static public void sortAddresses(String inputName, String outputName) throws Exception {
        BufferedReader br = new BufferedReader(new InputStreamReader(
                new FileInputStream(inputName), Charset.forName("UTF-8")));
        String line;
        ...
        while ((line = br.readLine()) != null) {
            if (line.contains("-")) {
                ...
                //String [] streetAndNumber = line.replaceAll("\\s-\\s[a-z]+\\s[1-9]+", "").split(" ");
                String[] person = line.replaceAll("[а-яА-Я]+\\s[а-яА-Я]+\\s+-\\s", "").trim().split(" ");
